 ...
 *
 * @see https://github.com/dcastil/tailwind-merge/blob/tailwind-merge@3.7.0/packages/tailwind-merge/docs/configuration.md#theme
...
declare const getDefaultConfig: () => {
    ...
    readonly classGroups: {
        ...
        readonly columns: readonly [{
            readonly columns: readonly [(value: string) => boolean, "auto", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * Break After
        ...
        readonly 'inline-size': readonly [{
            readonly inline: readonly ["auto", ThemeGetter, (value: string) => boolean, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * Min-Inline Size
        ...
        readonly 'min-inline-size': readonly [{
            readonly 'min-inline': readonly ["auto", ThemeGetter, (value: string) => boolean, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * Max-Inline Size
        ...
        readonly 'max-inline-size': readonly [{
            readonly 'max-inline': readonly ["none", ThemeGetter, (value: string) => boolean, "screen", "full", "dvw", "lvw", "svw", "min", "max", "fit", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * Block Size
        ...
        readonly 'max-h': readonly [{
            readonly 'max-h': readonly ["screen", "lh", "none", (value: string) => boolean, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * Font Size
        ...
        readonly leading: readonly [{
            readonly leading: readonly ["none", ThemeGetter, (value: string) => boolean, (value: string) => boolean, ThemeGetter];
        }];
        /**
         * List Style Image
        ...
        readonly shadow: readonly [{
            readonly shadow: readonly ["", "inner", "none", ThemeGetter, (value: string) => boolean, (value: string) => boolean];
        }];
        /**
         * Box Shadow Color
    ...
    readonly conflictingClassGroups: {
        ...
        readonly 'inset-x': readonly ["start", "end", "right", "left"];
        readonly 'inset-y': readonly ["inset-bs", "inset-be", "top", "bottom"];
        ...
        readonly px: readonly ["ps", "pe", "pr", "pl"];
        readonly py: readonly ["pbs", "pbe", "pt", "pb"];
        readonly m: readonly ["mx", "my", "ms", "me", "mbs", "mbe", "mt", "mr", "mb", "ml"];
        readonly mx: readonly ["ms", "me", "mr", "ml"];
        readonly my: readonly ["mbs", "mbe", "mt", "mb"];
        ...
        readonly 'border-w-x': readonly ["border-w-s", "border-w-e", "border-w-r", "border-w-l"];
        readonly 'border-w-y': readonly ["border-w-bs", "border-w-be", "border-w-t", "border-w-b"];
        ...
        readonly 'border-color-x': readonly ["border-color-s", "border-color-e", "border-color-r", "border-color-l"];
        readonly 'border-color-y': readonly ["border-color-bs", "border-color-be", "border-color-t", "border-color-b"];
        ...
        readonly 'scroll-mx': readonly ["scroll-ms", "scroll-me", "scroll-mr", "scroll-ml"];
        readonly 'scroll-my': readonly ["scroll-mbs", "scroll-mbe", "scroll-mt", "scroll-mb"];
        ...
        readonly 'scroll-px': readonly ["scroll-ps", "scroll-pe", "scroll-pr", "scroll-pl"];
        readonly 'scroll-py': readonly ["scroll-pbs", "scroll-pbe", "scroll-pt", "scroll-pb"];
